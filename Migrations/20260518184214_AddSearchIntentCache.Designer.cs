...
namespace EventsApp.Migrations
{
    ...
    [Migration("20260518184214_AddSearchIntentCache")]
    partial class AddSearchIntentCache
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventsApp.Models.AI.SearchIntentCacheEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("SearchIntentCacheEntries");
                });
            ...
            modelBuilder.Entity("EventsApp.Models.Conversation", b =>
                {
                    ...
                    b.Property<DateTime?>("ArchivedByP1At")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("ArchivedByP2At")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("MutedByP1Until")
                        .HasColumnType("timestamp without time zone");

                    b.Property<DateTime?>("MutedByP2Until")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("EventsApp.Models.EmailConfirmationRequest", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
            ...
            modelBuilder.Entity("EventsApp.Models.MessageLike", b =>
                {
            ...
            modelBuilder.Entity("EventsApp.Models.MessageReaction", b =>
                {
                    b.Property<int>("MessageId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EventsApp.Models.OrganizerProfile", b =>
                {
                    ...
                    b.Property<int>("PastEventsCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EventsApp.Models.PasswordResetRequest", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
            ...
            modelBuilder.Entity("EventsApp.Models.RevokedJwtToken", b =>
                {
            ...
            modelBuilder.Entity("EventsApp.Models.UserPushSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EventsApp.Models.Conversation", b =>
                {
                    ...
                    b.HasOne("EventsApp.Models.Message", "PinnedMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("EventsApp.Models.Message", b =>
                {
                    ...
                    b.HasOne("EventsApp.Models.Message", "ReplyToMessage")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("EventsApp.Models.MessageLike", b =>
                {
                    b.HasOne("EventsApp.Models.Message", "Message")
                        .WithMany("Likes")
